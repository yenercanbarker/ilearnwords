...
include("veritabani.php");
 ...
 $id = $_POST['id'];
 $kelime = $_POST['kelime'];
 $kelimetipi = $_POST['kelimetipi'];
 $kelimeninturkcesi = $_POST['kelimeninturkcesi'];
 $cumle = $_POST['cumle'];

$sql="INSERT INTO ogrenilecekkelimeler (id, kelime, kelimetipi, kelimeninturkcesi, cumle) 
VALUES ('$id','$kelime','$kelimetipi','$kelimeninturkcesi','$cumle')";

$sorgu_calistir = $baglan->query($sql);

if($sorgu_calistir === TRUE)
{
    echo '<div class="container mt-3"> <div class="row justify-content-center"> <div class="alert alert-success" role="alert">
    Başarılı...
  </div> </div> </div>';
}
else
echo '<div class="container mt-3"> <div class="row justify-content-center"> <div class="alert alert-danger" role="alert">
Başarısız...
</div> </div> </div>';  

$baglan -> Set_charset("utf8");

$sql = "SELECT * FROM ogrenilecekkelimeler";
...
echo '<div class="col-md-4 kutu">'.'<div class="col-md-12">'."Kelime :".$kelime."<br>"."Kelime Tipi :".$kelimetipi."<br>"."Kelimenin Türkçesi :".$kelimeninturkcesi."<br>"."Cümle :".$cumle."<br>".
'</div>'.'</div>';
}  
