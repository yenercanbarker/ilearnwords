...
<header class="masthead">
  <div class="container pb-4 mx-auto ml-2 mr-2">
    <div class="row ml-1 mr-1">
      <!-- Kelime Ekleme Formu / Bu formda eklenmesini istediğimiz kelimeleri textboxlara dolduruyoruz. -->
      <div class="ekleformu col-md-9 mt-5 p-4 pr-5 pl-5 mr-auto ml-auto bg-white">
        <div class="alert text-center alert-info alert-dismissible fade show" role="alert">
          <strong> iLearnWords - Kelime Ekle </strong> <br> <br> Bu bölümde veri tabanına eklenmesini istediğiniz kelimeyi formda doldurunuz.
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form id="fupForm" class="ml-auto mr-auto mt-4" method="post">
          ...
          <div class="form-group">
            ...
            <input id="cumle" type="text" class="form-control" placeholder="Bir cümle giriniz...">
          </div>
          <button id="butsave" type="button" class="btn btn-primary mt-2 mb-2 "> Veri Tabanına Ekle </button>
        </form>
      </div>
    </div>
  </div>
...
<!-- Bootstrap yapısının sayfaya entegre edilmesi için gereken CDN kodları. -->
<script src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin="anonymous"></script>
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
<script src="js/sweetalert2.min.js"></script>

<!-- Responsive navbardaki butonun açılıp kapanması için gerekli javascript kodu. -->
<script src="js/script.js"></script>

<script>
/* Bu fonksiyon AJAX yapısıyla verileri sayfayı yenilemeden postlama işlemini yapmaktadır. */
$(document).ready(function() {
	$('#butsave').on('click', function() {
    $("#butsave").attr("disabled", "disabled");
    // Form elemanlarını javascript değişkenlerine atıyoruz.
    var databasename = "kelimeler";
		var kelime = $('#kelime').val();
		var kelimetipi = $('#kelimetipi').val();
		var kelimeninturkcesi = $('#kelimeninturkcesi').val();
    var cumle = $('#cumle').val();
    // Form elemanları boş değilse AJAX yapısıyla POST işlemini gerçekleştiriyoruz.
        ...
        // Eğer POST işlemi başarılıysa bu alana giriş yapıyoruz.
          ...
          {					
            ...
            Swal.fire(
        'Başarısız!',
        'Bu kelimeyi daha önce eklediniz!',
        'error'
      )
          }
				}
